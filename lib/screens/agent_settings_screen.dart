...
class _AgentSettingsScreenState extends State<AgentSettingsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final settings = await _service.getSettings(widget.user.id,
            ...
            for (final lang in AppLanguage.values)
              RadioListTile<AppLanguage>(
                ...
                onChanged: (v) async {
                  ...
                  try {
                    await _service.updateSettings(widget.user.id,
                        language: v.apiValue, token: widget.user.token ?? '');
                  } on AgentServiceException catch (e) {
                    if (!mounted) return;
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: PrimaryButton(
                                ...
                                onPressed:
                                    _savingAccount ? null : _saveAccount)),
                    ...
                    _SectionCard(
                      ...
                      children: [
                        ...
                        _SwitchRow(
                            ...
                            onChanged: (v) =>
                                _updateNotification('notifyPayouts', v)),
                        _SwitchRow(
      ...
      return Column(
        ...
        children: [
          ...
          TextField(
            ...
            autofocus: true,
            decoration:
                const InputDecoration(hintText: 'Enter full account number'),
          ),
          const SizedBox(height: 4),
          const Text('Only the last 4 digits are kept after saving.',
        ...
        children: [
          ...
          TextField(
              ...
              decoration: InputDecoration(
                  labelText: 'Confirm new password', errorText: _error)),
          const SizedBox(height: AppSpacing.lg),
          SizedBox(
            width: double.infinity,
            child: PrimaryButton(
