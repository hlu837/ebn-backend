...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    // Agency Name / License-ID is no longer collected on the Agent request
    // form (removed for now, per request) — agencyOrLicense is optional and
    // simply stored as null when omitted.
