...
class _EBNLandingPageState extends State<EBNLandingPage> {
  ...
  final List<String> _tabs = const ['For You', 'Vehicles', 'Real Estate', 'Machinery'];
  ...
  void _handleQuickAction(int index) {
    switch (index) {
      case 0: // Post Ad
        ...
        break;
      case 1: // Vehicles
        _goToCategory(AssetCategorySlug.vehicles, 'Vehicles', Icons.directions_car_outlined);
        break;
      case 2: // Machinery
        _goToCategory(AssetCategorySlug.machinery, 'Machinery', Icons.terrain_outlined);
        break;
      case 3: // House
        _goToCategory(AssetCategorySlug.house, 'House', Icons.home_outlined);
        break;
      case 4: // Warehouse
        _goToCategory(AssetCategorySlug.warehouse, 'Warehouse', Icons.warehouse_outlined);
        break;
      case 5: // Land
        _goToCategory(AssetCategorySlug.land, 'Land', Icons.landscape_outlined);
        break;
      case 6: // Materials
        _goToCategory(AssetCategorySlug.constructionMaterials, 'Construction Materials', Icons.swap_horiz);
        break;
      case 7: // Brokers
        Navigator.of(context).push(MaterialPageRoute(
  ...
  void _handleTabSelect(int index) {
    ...
    if (index == 1) { // Vehicles
      _goToCategory(AssetCategorySlug.vehicles, 'Vehicles', Icons.directions_car_outlined);
    } else if (index == 2) { // Real Estate
      _goToCategory(AssetCategorySlug.house, 'Real Estate', Icons.home_outlined);
    } else if (index == 3) { // Machinery
      _goToCategory(AssetCategorySlug.machinery, 'Machinery', Icons.terrain_outlined);
    }
  }
              ...
              IconButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Language selector: English (default)')),
                  );
                },
              ),
            ],
  ...
  Widget _buildSafetyBanner() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.verified_user_outlined, color: EBNColors.red, size: 18),
              ...
              text: const TextSpan(
                ...
                children: [
                  TextSpan(
                    ...
                    style: TextStyle(fontWeight: FontWeight.w700, color: EBNColors.red),
                  ),
                  TextSpan(
                    text: 'Request an on-site inspection before making transactions.',
                  ),
                ],
              ),
            ),
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Container(
                        ...
                        child: const Icon(Icons.verified, color: Colors.white54, size: 48),
                      );
                    },
                  ),
                ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              _goToCategory(AssetCategorySlug.house, 'All Trending Ads', Icons.trending_up);
            },
            child: Row(
              children: const [
                Text(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => AssetDetailScreen(asset: mockAsset, user: _kGuestUser),
              ));
            },
            child: _AdCard(ad: ad),
          );
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.location_on_outlined, size: 12, color: EBNColors.grey),
