    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Icon(Icons.chat_bubble_outline_rounded, size: 44, color: AppColors.slate),
            const SizedBox(height: 14),
            const Text('No conversations yet', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.ink)),
