...
class AdminSettingsScreen extends StatelessWidget {
  const AdminSettingsScreen({super.key, required this.token, required this.currentAdminId});
            ...
            _SettingsSection(
              ...
              items: [
                _SettingsItem(
                  ...
                  onTap: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => AdminAccountsScreen(token: token, currentAdminId: currentAdminId),
                  )),
                ),
                _SettingsItem(
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(title, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: AppColors.slate, letterSpacing: 0.4)),
        ),
        Container(
